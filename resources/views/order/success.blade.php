    ...
    <div class="min-h-[calc(100vh-60px)] flex items-center justify-center p-4">
        <div class="w-full max-w-md">
            ...
            <div class="text-center mb-6">
                <div
                    class="inline-flex items-center justify-center w-24 h-24 bg-gradient-to-br from-green-400 to-emerald-500 rounded-full shadow-2xl shadow-green-200 mb-4 animate-bounce">
            ...
            <div class="bg-white rounded-3xl shadow-xl overflow-hidden border border-gray-100">
                ...
                <div class="relative">
                    <div
                        class="absolute -left-4 top-0 w-8 h-8 bg-gradient-to-br from-orange-50 via-white to-amber-50 rounded-full">
                    </div>
                    <div
                        class="absolute -right-4 top-0 w-8 h-8 bg-gradient-to-br from-orange-50 via-white to-amber-50 rounded-full">
                    </div>
                ...
                <div class="p-6 space-y-4">
                    ...
                    <div class="pt-4 border-t border-gray-100">
                        <div class="flex justify-between items-center">
                            ...
                            <span class="text-2xl font-black gradient-text">Rp
