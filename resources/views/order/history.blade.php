                    ...
                    <div class="p-5 border-b border-gray-100">
                        <div class="flex justify-between items-start">
                            <div class="flex items-center gap-3">
                                <div
                                    class="w-12 h-12 bg-gradient-to-br from-amber-100 to-orange-100 rounded-2xl flex items-center justify-center">
                            ...
                            <div class="text-right">
                                <p class="font-black text-lg gradient-text">Rp
                    ...
                    <div class="px-5 py-4 bg-gray-50">
                        <div class="flex flex-wrap gap-2">
                            @foreach($order->items as $item)
                                <span
                                    class="inline-flex items-center gap-1 bg-white px-3 py-1.5 rounded-full text-xs font-medium text-gray-700 border border-gray-200">
